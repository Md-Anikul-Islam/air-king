            ...
            <div class="card-body">
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    @foreach($productDesign as $key=> $productDesignData)
                        <tr>
                            ...
                            <td>
                                ...
                                @foreach($productDesignData->rawMaterials as $rawMaterial)
                                    ...
                                    @php($totalPrice += $rawMaterial->per_unit_price*$rawMaterial->quantity)
                                @endforeach
                            </td>
                                ...
                                <div class="d-flex justify-content-end gap-1">
                                    @can('product-design-edit')
                                        <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#editNewModalId{{$productDesignData->id}}">Edit
                                        </button>
                                    @endcan
                                    @can('product-design-delete')
                                        <a href="{{route('product.design.destroy',$productDesignData->id)}}"
                                           class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                           data-bs-target="#danger-header-modal{{$productDesignData->id}}">Delete</a>
                                    @endcan
                                </div>
                            </td>
                        </tr>
                        ...
                        <!--Edit Modal -->
                        <div class="modal fade" id="editNewModalId{{$productDesignData->id}}"
                             data-bs-backdrop="static"
                             tabindex="-1" role="dialog"
                             aria-labelledby="editNewModalLabel{{$productDesignData->id}}"
                             aria-hidden="true">
                            <div class="modal-dialog modal-lg  modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="addNewModalLabel{{$productDesignData->id}}">
                                            Edit</h4>
                                    ...
                                    <div class="modal-body">
                                        <form method="post"
                                              action="{{route('product.design.update',$productDesignData->id)}}"
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        <label for="example-select" class="form-label">Product
                                                            Category</label>
                                                        <select name="product_category_id" class="form-select">
                                                            <option value="" selected>Product Category Select
                                                            </option>
                                                            @foreach($productCategory as $productCategoryData)
                                                                <option
                                                                    value="{{$productCategoryData->id}}" {{ $productDesignData->product_category_id == $productCategoryData->id ? 'selected' : '' }}>{{$productCategoryData->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="product_name" name="product_name"
                                                               ...
                                                               value="{{$productDesignData->product_name}}"
                                                               required>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="product_color_id" class="form-select">
                                                            ...
                                                            @foreach($color as $colorData)
                                                                <option
                                                                    value="{{$colorData->id}}" {{ $productDesignData->product_color_id == $colorData->id ? 'selected' : '' }}>{{$colorData->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="product_version"
                                                               name="product_version"
                                                               class="form-control" placeholder="Enter Version"
                                                               value="{{$productDesignData->product_version}}"
                                                               required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="status" class="form-select">
                                                            <option
                                                                value="1" {{ $productDesignData->status === 1 ? 'selected' : '' }}>
                                                                Active
                                                            </option>
                                                            <option
                                                                value="0" {{ $productDesignData->status === 0 ? 'selected' : '' }}>
                                                                Inactive
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <input type="hidden" name="raw_materials_json"
                                                       id="raw-materials-json-{{$productDesignData->id}}"
                                                       value="{{ json_encode($productDesignData->rawMaterials->pluck('raw_material_id', 'quantity')->toArray()) }}">
                                                        ...
                                                        <div class="row raw-material-field mb-3">
                                                            <div class="col-5">
                                                                ...
                                                                <select name="raw_material_id[]"
                                                                        class="form-select">
                                                                    <option value="" selected>Select Raw Material
                                                                    </option>
                                                                    @foreach($rawMaterialInfo as $rawMaterialInfoData)
                                                                        <option
                                                                            value="{{ $rawMaterialInfoData->id }}" {{ $rawMaterial->raw_material_id == $rawMaterialInfoData->id ? 'selected' : '' }}>
                                                            ...
                                                            <div class="col-2 d-flex align-items-end">
                                                                <button type="button"
                                                                        class="btn btn-danger remove-raw-material-field">
                                                                    Remove
                                                                </button>
                                                            </div>
                                                        </div>
                        ...
                        <!-- Delete Modal -->
                        <div id="danger-header-modal{{$productDesignData->id}}" class="modal fade" tabindex="-1"
                             role="dialog" aria-labelledby="danger-header-modalLabel{{$productDesignData->id}}"
                             aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header modal-colored-header bg-danger">
                                        <h4 class="modal-title"
                                            id="danger-header-modalLabe{{$productDesignData->id}}l">
                                            Delete</h4>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <select name="product_category_id" class="form-select">
                                        ...
                                        @foreach($productCategory as $productCategoryData)
                                            <option
                                                value="{{$productCategoryData->id}}">{{$productCategoryData->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="row raw-material-field mb-3">
                                    <div class="col-5">
                                        ...
                                        <select name="raw_material_id[]" class="form-select">
                                            ...
                                            @foreach($rawMaterialInfo as $rawMaterialInfoData)
                                                <option
                                                    value="{{ $rawMaterialInfoData->id }}">{{ $rawMaterialInfoData->raw_material_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-5">
                                    ...
                                    <div class="col-2 d-flex align-items-end">
                                        <button type="button" class="btn btn-danger remove-raw-material-field">Remove
                                        </button>
                                    </div>
                                </div>
                            </div>
