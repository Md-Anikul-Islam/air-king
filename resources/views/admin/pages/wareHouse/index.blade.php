                        ...
                        <tr>
                            ...
                            <td style="width: 100px;">
                                <div class="d-flex justify-content-end gap-1">
                                    ...
                                    @endcan
                                    @can('wareHouse-section-delete')
                                        <a href="{{route('wareHouse.destroy',$data->id)}}" class="btn btn-danger btn-sm"
                                                                ...
                                                                @if (!empty($units))
                                                                    @foreach ($units as $unit)
                                                                        <option value="{{ $unit->id }}"
                                                                                @if (!empty($data->unit_id) && $data->unit_id == $unit->id) selected @endif>
                                                                            {{ $unit->name ?? '' }}
                                                                        </option>
                                                                    @endforeach
                                                                @endif
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{route('wareHouse.destroy',$data->id)}}"
