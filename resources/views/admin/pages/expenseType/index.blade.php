        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-end">
                    @can('expenseType-section-create')
            ...
            <div class="card-body">
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                    @foreach($expenseTypes as $key=>$data)
                        <tr>
                            <td>{{$key+1}}</td>
                            <td>{{$data->name}}</td>
                            ...
                            <td style="width: 100px;">
                                <div class="d-flex justify-content-end gap-1">
                                    @can('expenseType-section-edit')
                                        <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#editNewModalId{{$data->id}}">Edit
                                        </button>
                                    @endcan
                                    @can('expenseType-section-delete')
                                        <a href="{{route('expenseType.destroy',$data->id)}}" class="btn btn-danger btn-sm"
                                ...
                                <div class="modal-dialog  modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{route('expenseType.update',$data->id)}}"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{route('expenseType.destroy',$data->id)}}"
    ...
    <div class="modal fade" id="addNewModalId" data-bs-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-lg">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('expenseType.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
