                        ...
                        <tr>
                            ...
                            <td style="width: 100px;">
                                <div class="d-flex justify-content-end gap-1">
                                    @can('block-section-edit')
                                        <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#editNewModalId{{$data->id}}">Edit
                                        </button>
                                    @endcan
                                    @can('block-section-delete')
                                        <a href="{{route('block.destroy',$data->id)}}" class="btn btn-danger btn-sm"
                                ...
                                <div class="modal-dialog  modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{route('block.update',$data->id)}}"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="name" name="name"
                                                                   value="{{$data->name}}"
                                                                   class="form-control" placeholder="Enter Block Name"
                                                                   required>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{route('block.destroy',$data->id)}}"
    ...
    <div class="modal fade" id="addNewModalId" data-bs-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-lg">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('block.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
