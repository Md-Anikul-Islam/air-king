...
class SiteSettingController extends Controller
{
    ...
    public function createOrUpdate(Request $request, $id = null)
    {
        ...
        $rules = [
            ...
            'favicon' => 'nullable|image|mimes:jpeg,png,jpg,svg,gif|max:5120',
            'logo' => 'nullable|image|mimes:jpeg,png,jpg,svg,gif|max:5120',
            'site_preview_image' => 'nullable|image|mimes:jpeg,png,jpg,svg,gif|max:5120',
